...
[https://github.com/mauriciovancine/workshop-r-data-visualization](https://github.com/mauriciovancine/workshop-r-data-visualization)
...
::: footer
[workshop-r-data-visualization](https://github.com/mauriciovancine/workshop-r-data-visualization)
:::
...
- [scico](https://github.com/thomasp85/scico): paleta de cores do "Scientific Colour-Maps"
...
- Compatível com `ggplot2`, mapas e gráficos **acessíveis e consistentes**
:::

![](img/scico.png){.absolute width=400 right=630 top=280}
![](img/scico_colors01.webp){.absolute width=380 right=250 top=270}
![](img/scico_colors02.webp){.absolute width=390 right=-120 top=270}

::: footer
[scico](https://github.com/thomasp85/scico), [Scientific colour maps](https://www.fabiocrameri.ch/colourmaps/)
:::
...
![](img/scico.png){.absolute width=400 right=630 top=280}
![](img/scico_colors03.webp){.absolute width=600 right=0 top=260}
...
ggsave(filename = "density_ggplot2.pdf", plot = ggplot_densidade, 
...
ggsave(filename = "density_ggplot2.svg", plot = ggplot_densidade, 
